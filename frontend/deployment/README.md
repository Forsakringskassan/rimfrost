...
Det andra teamet behöver alltså skapa motsvarande config-injektion (ConfigMap + volume mount i OpenShift, eller motsvarande) för varje FE-app, med rätt `RUNTIME_BFF_URL` för respektive BFF i sitt eget kluster. Se även [portal/README.md](../portal/README.md) och [micro-fe/README.md](../micro-fe/README.md) för hur apparna läser detta i sin egen kod (`src/config/env.ts`).
